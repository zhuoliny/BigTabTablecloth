...
public class saveInfo {
    ...
    public saveInfo(Context context) {
        ...
        _context = context;
        _fileName = "TbClth_UserInfo.csv";
    }

    public void save(String name, int age, String gender, String more) {
        ...
        try {
            ...
            string += load();
            String value = "";
            string += hour + ":" + minute + ":" + second + "," + name + "," + age + "," + gender + "," + more + ";";
